...
class CPKodiSkill(CommonPlaySkill):
    ...
    def play_film(self, movieid):
        ...
        kodi_tools.add_playlist(self.kodi_path, movieid)
        if kodi_tools.check_cinemavision_present(self.kodi_path):  # Cinemavision is installed
            ...
            kodi_tools.play_normal(self.kodi_path)
    ...
    def find_movies_with_filter(self, title=""):
        ...
        movie_list = kodi_tools.list_all_movies(self.kodi_path)
    ...
    def CPS_match_query_phrase(self, phrase):
        ...
        movie_name = self.movie_regex(phrase)
